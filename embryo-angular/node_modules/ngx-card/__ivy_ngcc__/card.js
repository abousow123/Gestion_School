...
NgxCard.ɵfac = function NgxCard_Factory(t) { return new (t || NgxCard)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef)); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgxCard, [{
        type: Directive,
        args: [{
                selector: '[card]'
            }]
    }], function () { return [{ type: ɵngcc0.ElementRef }]; }, { formatting: [{
            type: Input
        }], debug: [{
            type: Input
        }], messages: [{
